...
static const char *SCENE_NAMES[] = { "tide", "bloom", "drift", "lark", "prism", "swell" };
...
int main(int argc, char **argv) {
    ...
    for (int i = 1; i < argc; i++) {
        if (!strcmp(argv[i], "-f") || !strcmp(argv[i], "--fullscreen")) {
            ...
            printf("usage: seaglass [-f] [-s tide|bloom|drift|lark|prism|swell] [-w width] [-h height] [--selftest]\n");
    ...
    printf("seaglass: scenes: 1 tide  2 bloom  3 drift  4 lark  5 prism  6 swell  (space cycles)\n");
